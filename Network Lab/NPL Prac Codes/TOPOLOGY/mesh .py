...
if __name__ == "__main__":
    ...
    print("Bus server started.Connect client by 'telnet localhost 8000'")
    print(
        "Enter your name as first message to register. To send a message to a particular username use '@username: message'. To send message to everyone, just type the message."
    )
    reactor.run()
